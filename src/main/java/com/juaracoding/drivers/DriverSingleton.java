...
public class DriverSingleton {
    ...
    private DriverSingleton(String driver){
        instantiate(driver);
        this.js = (JavascriptExecutor) this.driver; // casting WebDriver driver menjadi JavascriptExecutor js
    }
    ...
    //Menambahkan Method selectDropdownByValue
    public static void selectDropdownByValue(WebElement a, String val){
